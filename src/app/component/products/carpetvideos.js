...
const CarpetVideos = () => {
    ...
    return (
        <section className="video_guide video_section carpetTiles" data-section="video_guide">
...
<SwiperSlide>
                            ...
                            <SwiperSlide>
                                <div className="swiper-slide">
                                    <h3 className="subtitle_35">
                                    Welspun Flooring - ResilonX Story
                                    </h3>
                                    {/* <div className="product_cta">
                                        <a href="" className="view_link whiteBrd">
                                            <div className="link_cta">
                            ...
                            <SwiperSlide>
                                <div className="swiper-slide">
                                    <h3 className="subtitle_35">
                                    ResilonX - Sustainable Story from Welspun Flooring
                                    </h3>
                                    {/* <div className="product_cta">
                                        <a href="" className="view_link whiteBrd">
                                            <div className="link_cta">
                                ...
                                <div className="swiper-slide">
                                    <div className="video_player">
                                        ...
                                        <iframe
                                            ...
                                            width="560"
                                            height="315"
                                            src="https://www.youtube.com/embed/f2Racoo5JB0?enablejsapi=1&rel=0&controls=0"
                                            title="YouTube video player"
                                            style={{ border: 'none' }}
                                            allow="autoplay; encrypted-media"
                                            allowFullScreen
                            ...
                            <SwiperSlide>
                                <div className="swiper-slide">
                                    <div className="video_player">
                                        ...
                                        <iframe
                                            ref={(el) => (ytPlayersRef.current[2] = el)}
                                            width="560"
                                            height="315"
                                            src="https://www.youtube.com/embed/-fhWpkcHXO4?enablejsapi=1&rel=0&controls=0"
                                            title="YouTube video player"
                                            style={{ border: 'none' }}
                                            allow="autoplay; encrypted-media"
                                            allowFullScreen
