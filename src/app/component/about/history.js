      ...
      <div className="section_container">
        ...
        <div className="title_container">
          <div className="history_para">
            Welspun Group is a US$ 3 billion company and is one of India's fastest-growing conglomerates, with a strong presence in textiles and flooring solutions worldwide.
