    ...
    <section data-section="about_history" className="about_history">
      <div className="section_container">
        ...
        <div className="title_container">
          ...
          Welspun World is a US$ 5 billion dollars company and is one of India's fastest-growing conglomerates, with a strong presence in textiles and flooring solutions worldwide.
